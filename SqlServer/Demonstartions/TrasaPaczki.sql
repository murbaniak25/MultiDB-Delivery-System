...
CREATE OR ALTER PROCEDURE sp_SymulujCyklZyciaPrzesylki
    @PrzesylkaID INT
AS
BEGIN
    SET NOCOUNT ON;
    ...
    PRINT '';
    PRINT '=== SYMULACJA CYKLU ŻYCIA PRZESYŁKI #' + CAST(@PrzesylkaID AS VARCHAR(10)) + ' ===';
...
EXEC sp_SymulujCyklZyciaPrzesylkiV2 @PrzesylkaID = 10;
